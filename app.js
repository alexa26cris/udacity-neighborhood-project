...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "YPR4MJSD1HVGKFPBSZQRKRAZ3IBMV4A022AU4RQGXS20UW0J";
            clientSecret =
                "AQO3G4P0K1YW4C2PZW3WA4HGUFARSYJQSMPLZQTISVRCK0AG";
            ...
            $.getJSON(apiUrl).done(function(marker) {
                ...
                // Send alert
                alert(
                    "There is a problem loading the Foursquare API. Refresh your page to try again."
                );
            });
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(52.350785, 5.264702),
            zoom: 16,
            styles: styles
        };
...
googleError = function googleError() {
    alert(
        'Google Maps did not load. Refresh this page to try again!'
    );
};
